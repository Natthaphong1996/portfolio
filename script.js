const translations = {
    th: {
        ...
        infra_item_pdu_n: "PDU (Power Distribution Unit)",
        infra_item_pdu_d: "ชุดปลั๊กไฟอัจฉริยะในตู้แร็ค ทำหน้าที่กระจายไฟให้ Server และ Metering การใช้พลังงาน",
        ...
        pdu_detail: "ชุดกระจายกำลังไฟฟ้าอัจฉริยะที่ติดตั้งในตู้แร็ค สามารถวัดค่าการใช้พลังงานได้แม่นยำ (Monitoring) ช่วยให้บริหารจัดการโหลดไฟฟ้าของ Server ในแต่ละตู้ไม่ให้เกินพิกัด",
    ...
    en: {
        ...
        infra_item_pdu_n: "PDU (Power Distribution Unit)",
        infra_item_pdu_d: "Power distribution unit within the rack, distributes power to servers and monitors energy usage.",
        ...
        pdu_detail: "Intelligent Power Distribution Unit in racks. It provides precise energy metering and monitoring, helping to manage electrical loads and prevent server rack overloading.",
